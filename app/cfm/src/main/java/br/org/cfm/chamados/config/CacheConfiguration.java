...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        ...
        return () ->
            GlobalConfigurationBuilder
                ...
                .clusterName("infinispan-chamados-cluster")
                .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    br.org.cfm.chamados.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    br.org.cfm.chamados.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(cacheName ->
                    manager.defineConfiguration(
                        cacheName,
